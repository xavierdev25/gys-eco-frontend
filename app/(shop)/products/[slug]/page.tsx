...
// Mock data extended with details
const products = [
  {
    id: "1",
  ...
  },
  {
    ...
    gallery: [
      ...
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCIUdPNq1MaXA-I98sqaD51iNrkKVSyWjxDCWhKw5474TlNuq7WZceixXDtgHLxT0O69I7VdG-cmwduGefjcotl8Ke-6cwXhz81Ij9ZharxV_BrOXYAYrWf_9THWITaNxKEp085Dq-A9X7bHhLRrinry5ceMSGP-7IbT_vIKkzL2mcYTnsMGsWuGCpgo1sTNkXYinTFxFEd1Dq9TMIerTGye8aI3R2aP006Oq6XMgqWGF008AoN5oU54N9874N2DxCRfAjZj6fHEcY",
    ],
  },
  {
    id: "5",
    ...
    <>
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="flex flex-wrap gap-2 mb-8">
          ...
          <span className="text-[#5f8676] text-sm font-medium leading-normal capitalize">
            {product.category}
          </span>
          <span className="text-[#5f8676] text-sm font-medium leading-normal">
            /
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
            ...
            {product.gallery && product.gallery.length > 1 && (
              <div className="grid grid-cols-[repeat(auto-fit,minmax(80px,1fr))] gap-4">
                {product.gallery.slice(1).map((img, index) => (
                  ...
                  >
                    <div className="relative w-full aspect-square rounded-lg border-2 border-transparent hover:border-[#1B4332] overflow-hidden transition-colors">
                      <Image
                        src={img}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              <button className="flex-1 flex min-w-[150px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-[#1B4332] text-white text-base font-bold leading-normal tracking-wide hover:bg-opacity-90 transition-opacity">
                <span className="truncate">Cotizar ahora</span>
              </button>
              <button className="flex-1 flex min-w-[150px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-transparent border-2 border-[#1B4332] text-[#1B4332] hover:bg-[#1B4332]/10 transition-colors">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {similarProducts.map((similar) => (
              <div key={similar.id} className="flex flex-col gap-4 group">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <p className="text-sm text-[#5f8676]">
                    {similar.category} - {similar.material}
                  </p>
                </div>
              </div>
            ))}
